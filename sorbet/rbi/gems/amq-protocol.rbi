...
class AMQ::Protocol::Connection::UpdateSecret < AMQ::Protocol::Method
  def initialize(new_secret, reason); end
  def new_secret; end
  def reason; end
  def self.decode(data); end
  def self.encode(new_secret, reason); end
  def self.has_content?; end
end
class AMQ::Protocol::Connection::UpdateSecretOk < AMQ::Protocol::Method
  def initialize; end
  def self.decode(data); end
  def self.encode; end
  def self.has_content?; end
