...
class Dry::Configurable::Setting
  ...
  def writer?(meth); end
  def writer_name; end
  include Anonymous_Dry_Core_Equalizer_35
  include Dry::Core::Equalizer::Methods
end
module Anonymous_Dry_Core_Equalizer_35
  def cmp?(comparator, other); end
  def hash; end
end
...
class Dry::Configurable::Settings
  ...
  def keys; end
  def pristine; end
  include Anonymous_Dry_Core_Equalizer_36
  include Dry::Core::Equalizer::Methods
  include Enumerable
end
module Anonymous_Dry_Core_Equalizer_36
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
