...
class Anonymous_Faraday_Options_86 < Faraday::Options
  def bind; end
  def bind=(_); end
  def boundary; end
  def boundary=(_); end
...
class Faraday::RequestOptions < Anonymous_Faraday_Options_86
  def []=(key, value); end
  def stream_response?; end
end
class Anonymous_Faraday_Options_87 < Faraday::Options
  def ca_file; end
  def ca_file=(_); end
  def ca_path; end
  def ca_path=(_); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_87
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_88 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_88
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_89
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_90
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_91
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
