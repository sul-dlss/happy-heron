...
class Dry::Schema::Config
  ...
  extend Dry::Configurable::ClassMethods
  include Anonymous_Dry_Equalizer_111
  include Dry::Configurable
  include Dry::Configurable::InstanceMethods
  include Dry::Equalizer::Methods
end
module Anonymous_Dry_Equalizer_111
  def cmp?(comparator, other); end
  def hash; end
end
class Dry::Schema::Message
  ...
  include Anonymous_Dry_Equalizer_112
  include Anonymous_Module_113
  include Dry::Equalizer::Methods
...
module Anonymous_Dry_Equalizer_112
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
...
module Dry::Schema::Types
  extend Anonymous_Dry_Core_Deprecations_Tagged_116
  extend Anonymous_Module_117
  extend Dry::Core::Deprecations::Interface
  extend Dry::Types::BuilderMethods
  include Anonymous_Dry_Types_Module_118
end
module Dry::Schema::Types::Definition
end
module Anonymous_Dry_Types_Module_118
  def self.included(base); end
  extend Dry::Types::BuilderMethods
end
module Anonymous_Dry_Core_Deprecations_Tagged_116
end
