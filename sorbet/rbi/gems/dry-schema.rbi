...
module Dry::Schema::Types
  extend Anonymous_Dry_Core_Deprecations_Tagged_131
  extend Anonymous_Module_132
  extend Dry::Core::Deprecations::Interface
  extend Dry::Types::BuilderMethods
  include Anonymous_Dry_Types_Module_133
end
module Dry::Schema::Types::Definition
end
module Anonymous_Dry_Types_Module_133
  def self.included(base); end
  extend Dry::Types::BuilderMethods
end
module Anonymous_Dry_Core_Deprecations_Tagged_131
end
...
class Dry::Schema::Result
  ...
  def update(hash); end
  extend Dry::Initializer
  include Anonymous_Dry_Equalizer_146
  include Anonymous_Module_147
  include Dry::Equalizer::Methods
  include Dry::Initializer::Mixin::Root
end
module Anonymous_Dry_Equalizer_146
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
