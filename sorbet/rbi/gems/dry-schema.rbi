...
class Dry::Schema::MessageSet
  ...
  def to_h; end
  def to_hash; end
  include Anonymous_Dry_Equalizer_131
  include Dry::Equalizer::Methods
  include Enumerable
end
module Anonymous_Dry_Equalizer_131
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
...
module Dry::Schema::Types
  extend Anonymous_Dry_Core_Deprecations_Tagged_133
  extend Anonymous_Module_134
  extend Dry::Core::Deprecations::Interface
  extend Dry::Types::BuilderMethods
  include Anonymous_Dry_Types_Module_135
end
module Dry::Schema::Types::Definition
end
module Anonymous_Dry_Types_Module_135
  def self.included(base); end
  extend Dry::Types::BuilderMethods
end
module Anonymous_Dry_Core_Deprecations_Tagged_133
end
...
class Dry::Schema::KeyCoercer
  ...
  include Anonymous_Dry_Equalizer_155
  include Dry::Core::Cache::Methods
  include Dry::Equalizer::Methods
end
module Anonymous_Dry_Equalizer_155
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
...
class Dry::Schema::KeyMap
  ...
  extend Dry::Core::Cache
  include Anonymous_Dry_Equalizer_165
  include Dry::Core::Cache::Methods
  include Dry::Equalizer::Methods
  include Enumerable
end
module Anonymous_Dry_Equalizer_165
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
