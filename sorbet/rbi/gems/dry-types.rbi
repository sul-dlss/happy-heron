...
class Dry::Types::Schema::Key
  ...
  def to_ast(meta: nil); end
  def try(input, &block); end
  extend Anonymous_Dry_Core_Deprecations_Tagged_80
  extend Dry::Core::Deprecations::Interface
...
module Anonymous_Dry_Core_Deprecations_Tagged_80
end
...
class Dry::Types::Compiler
  ...
  extend Anonymous_Dry_Core_Deprecations_Tagged_85
  extend Dry::Core::Deprecations::Interface
end
module Anonymous_Dry_Core_Deprecations_Tagged_85
end
