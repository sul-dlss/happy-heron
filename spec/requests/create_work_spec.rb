  ...
  context 'with an authenticated user' do
    ...
    describe 'create work' do
      ...
      context 'when a collection allows embargo and a license but restricts access and with all fields provided' do
        let(:collection) do
          create(:collection, :with_custom_rights_from_collection, depositors: [user],
        ...
        let(:authors) do
          { '0' =>
            ...
            { '_destroy' => 'false', 'first_name' => 'Naomi', 'weight' => '1',
              ...
              'affiliations_attributes' => { '0' => { '_destroy' => 'false', 'label' => 'Stanford University',
                                                      'uri' => 'http://ror.org/12345',
