      ...
      context 'when collection saves' do
        ...
        context 'with a custom rights statement provided by the collection' do
          ...
          it 'creates a new collection' do
            ...
            expect(collection.provided_custom_rights_statement).to eq 'These are the additional rights that were ' \
                                                                      'not already covered'
          end
        end
        ...
        context 'with a custom rights statement provided by the depositor' do
          let(:collection_custom_rights_params) do
            {
              ...
              provided_custom_rights_statement: 'Maybe entered some text here, but but then picked other options ' \
                                                'that caused it to get discarded',
              custom_rights_statement_custom_instructions: ''
          ...
          context 'with instructions provided by the collection' do
            let(:collection_custom_rights_instructions_params) do
              {
                custom_rights_statement_custom_instructions: 'Some things to consider when entering additional terms ' \
                                                             'of use not covered by your chosen license'
              }
            end
            ...
            it 'creates a new collection' do
              ...
              expect(collection.custom_rights_statement_custom_instructions).to eq 'Some things to consider when ' \
                                                                                   'entering additional terms of use ' \
                                                                                   'not covered by your chosen license'
            end
          end
