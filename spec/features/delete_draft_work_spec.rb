...
RSpec.describe 'Delete a draft work', :js do
  ...
  context 'when draft' do
    ...
    it 'allow users to delete the work and destroys the model from the dashboard' do
      ...
      click_link_or_button 'No' # dismiss the "Would you like to continue to working on your draft ..." dialog

      accept_confirm do
        within '#deposits-in-progress' do
          click_link_or_button "Delete #{work_version.title}"
        end
      end
    ...
    it 'allow users to delete the work and destroys the model from the dashboard' do
      ...
      accept_confirm do
        within '#your-collections' do
          click_link_or_button "Delete #{work_version_pending_approval.title}"
        end
      end
      sleep(1)
  ...
  context 'when rejected' do
    ...
    it 'allow users to delete the work and destroys the model from the dashboard' do
      ...
      accept_confirm do
        within '#your-collections' do
          click_link_or_button "Delete #{work_version_rejected.title}"
        end
      end
      sleep(1)
