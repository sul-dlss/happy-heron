...
RSpec.describe PopoverComponent, type: :component do
  context 'with an existing key' do
    ...
    context 'when tooltip contains html' do
      ...
      it 'renders the component' do
        expect(rendered.css('a').first['data-bs-content']).to eq 'Date or date range when the ' \
          'deposited work was collected, generated, or created. <strong>Unless you are ' \
          'depositing a dataset or content for Stanford University Archives, please do ' \
          'not enter a Creation Date</strong> The "Approximate" option should typically ' \
          'not be used with dates containing a month and/or day.'
      end
    end
  end
