...
RSpec.describe Works::FormComponent, type: :component do
  ...
  context 'when the collection allows a custom rights statement' do
    let(:collection) do
      build_stubbed(:collection, :depositor_selects_access, :with_custom_rights_from_depositor, id: 7)
    end
  ...
  context 'when the collection provides a custom rights statement' do
    let(:collection) do
      build_stubbed(:collection, :depositor_selects_access, :with_custom_rights_from_collection, id: 7)
    end
