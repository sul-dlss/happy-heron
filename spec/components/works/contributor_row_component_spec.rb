...
RSpec.describe Works::ContributorRowComponent do
  ...
  describe '#select_role' do
    ...
    it 'makes groups with headings' do
      expected = <<~HTML
        <select class="form-select" data-action="change-&gt;contributors#typeChanged" data-target="contributors.role" name="role_term" id="role_term"><optgroup label="Individual"><option value="person|Author">Author</option>
