  ...
  context 'when select attributes contain leading/trailing whitespace' do
    let(:work_version) do
      create(
        ...
        abstract: ' This proposal concerns the management of general information about ' \
    ...
    it 'strips the abstract' do
      expect(work_version.abstract).to eq('This proposal concerns the management of general information about ' \
