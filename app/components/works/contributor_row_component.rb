...
module Works
  ...
  class ContributorRowComponent < ApplicationComponent
    ...
    def select_person_role
      render ContributorRoleComponent.new(form:, contributor_type: 'person', visible: person?,
                                          data_options: data_options_for_select('person'))
    end

    def select_organization_role
      render ContributorRoleComponent.new(form:, contributor_type: 'organization', visible: organization?,
                                          data_options: data_options_for_select('organization'))
    end
